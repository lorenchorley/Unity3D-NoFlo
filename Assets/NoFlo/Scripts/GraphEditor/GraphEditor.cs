...
public class GraphEditor : MonoBehaviour {
    ...
    [Serializable]
    public class UnityEventNode : UnityEvent<Component> { }
    [Serializable]
    ...
    public void HandleAddNode(Component component) {
    ...
    public void HandleRemoveNode(Component component) {
    ...
    public void RenderGraph(Graph graph, Transform obj) {
        ...
        foreach (Component n in graph.NodesByName.Values) {
            HandleAddNode(n);
        }
    ...
    public void CenterGraph() {
        ...
        foreach (Component c in CurrentGraph.NodesByName.Values) {
